...
public class MyButtonScreen extends GameOptionsScreen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 + 5, this.height / 6 + 24, 150, 20, new TranslatableText("justanothermod.key.samePosScan"), (button) -> Util.getMainWorkerExecutor().execute(new BlockScanner(false))));
